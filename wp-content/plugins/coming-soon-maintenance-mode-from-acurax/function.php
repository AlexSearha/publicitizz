...
if(empty($acx_csma_display_var_arr))
{
	$acx_csma_display_var_arr=array(
								'year'=>array(
											'singular'=>__('Année',ACX_CSMA_WP_SLUG),
											'plural'=>__('Années',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Année',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Années',ACX_CSMA_WP_SLUG)
											),
								'month'=>array(
											'singular'=>__('Mois',ACX_CSMA_WP_SLUG),
											'plural'=>__('Mois',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Mois',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Mois',ACX_CSMA_WP_SLUG)
											),
								'week'=>array(
											'singular'=>__('Semaine',ACX_CSMA_WP_SLUG),
											'plural'=>__('Semaines',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Semaine',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Semaines',ACX_CSMA_WP_SLUG)
											),
								'day'=>array(
											'singular'=>__('Jour',ACX_CSMA_WP_SLUG),
											'plural'=>__('Jours',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Jour',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Jours',ACX_CSMA_WP_SLUG)
											),
								'hour'=>array(
											'singular'=>__('Heure',ACX_CSMA_WP_SLUG),
											'plural'=>__('Heures',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Heure',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Heure',ACX_CSMA_WP_SLUG)
											),
								'minute'=>array(
								...
								'second'=>array(
											'singular'=>__('Seconde',ACX_CSMA_WP_SLUG),
											'plural'=>__('Secondes',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Seconde',ACX_CSMA_WP_SLUG),
											'default_plural'=>__('Secondes',ACX_CSMA_WP_SLUG)
											),
								'next'=>array(
											'singular'=>__('Suivant',ACX_CSMA_WP_SLUG),
											'default_singular'=>__('Suivant',ACX_CSMA_WP_SLUG)
											)
							);
	if(!is_serialized($acx_csma_display_var_arr))
	{ 
